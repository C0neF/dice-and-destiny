...
@export var icon: Texture2D = preload("res://addons/milestone/icons/missing_icon.svg")
...
@export var hidden_icon: Texture2D = preload("res://addons/milestone/icons/hidden_achievement.svg")
